...
func generarCubo8vertices( vertices: PackedVector3Array, 
 							indices: PackedInt32Array):
	
	# Genera los vertices para un cubo, de lado 2
	# 0: vertices.append(Vector3(-1, -1, -1))
	# 1: vertices.append(Vector3(-1, -1, 1))
	# 2: vertices.append(Vector3(-1, 1, -1))
	# 3: vertices.append(Vector3(-1, 1, 1))
	# 4: vertices.append(Vector3(1, -1, -1))
	# 5: vertices.append(Vector3(1, -1, 1))
	# 6: vertices.append(Vector3(1, 1, -1))
	# 7: vertices.append(Vector3(1, 1, 1))
...
func generarCubo24vertices( vertices: PackedVector3Array, 
 							indices: PackedInt32Array):
	...
	vertices.append(Vector3(-1, -1, -1)) # 0
	vertices.append(Vector3(-1, -1, -1)) # 1 
	vertices.append(Vector3(-1, -1, -1)) # 2
	
	vertices.append(Vector3(-1, -1, 1)) # 3
	vertices.append(Vector3(-1, -1, 1)) # 4
	vertices.append(Vector3(-1, -1, 1)) # 5
	
	vertices.append(Vector3(-1, 1, -1)) # 6
	vertices.append(Vector3(-1, 1, -1)) # 7
	vertices.append(Vector3(-1, 1, -1)) # 8
	
	vertices.append(Vector3(-1, 1, 1)) # 9
	vertices.append(Vector3(-1, 1, 1)) # 10
	vertices.append(Vector3(-1, 1, 1)) # 11
	
	vertices.append(Vector3(1, -1, -1)) # 12
	vertices.append(Vector3(1, -1, -1)) # 13
	vertices.append(Vector3(1, -1, -1)) # 14
	
	vertices.append(Vector3(1, -1, 1)) # 15
	vertices.append(Vector3(1, -1, 1)) # 16
	vertices.append(Vector3(1, -1, 1)) # 17
	
	vertices.append(Vector3(1, 1, -1)) # 18
	vertices.append(Vector3(1, 1, -1)) # 19
	vertices.append(Vector3(1, 1, -1)) # 20
	
	vertices.append(Vector3(1, 1, 1)) # 21
	vertices.append(Vector3(1, 1, 1)) # 22
	vertices.append(Vector3(1, 1, 1)) # 23
