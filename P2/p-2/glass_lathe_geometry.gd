...
func _ready() -> void:
	...
	var profile := generateProfileGlass()
	var steps := 32
...
func generateProfileGlass() -> PackedVector2Array:
	var profile := PackedVector2Array([])
	
	# Outer wall
	profile.append(Vector2(0, 0))
	profile.append(Vector2(1.0, 0))
	profile.append(Vector2(1.0, 4.0))

	# Inner wall (slightly inset)
	profile.append(Vector2(0.8, 4.0))
	profile.append(Vector2(0.8, 0))
	profile.append(Vector2(0, 0))
